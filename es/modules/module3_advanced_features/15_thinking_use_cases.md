...
- Aplicaciones de baja latencia (Chatbots para consultas simples).

## Presupuesto
- **Pequeño (1k tokens):** Comprobaciones rápidas.
- **Medio (4k-8k):** Tareas de programación estándar.
- **Grande (16k+):** Investigación profunda, escritura de novelas.

## Próximos Pasos
- Aprende sobre la característica beta [Uso de Computadora](./16_computer_use.md).
