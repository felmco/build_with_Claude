...
1. Lee [Módulo 1: Fundamentos](./modules/module1_foundation/README.md)
2. Completa [Ejercicio 1: Hola Claude](./exercises/beginner/01_hello_claude.md)
...
2. Profundiza en [Módulo 2: API Principal](./modules/module2_core_api/README.md)
3. Explora [Módulo 3: Características Avanzadas](./modules/module3_advanced_features/README.md)
4. Construye [Proyecto 1: Bot de Soporte al Cliente](./projects/README.md)

**Tiempo**: 6-8 horas

### Ruta 3: Listo para Producción
1. Revisa los Módulos 1-3 rápidamente
2. Céntrate en [Módulo 4: Aplicaciones](./modules/module4_applications/README.md)
3. Domina [Módulo 5: Optimización](./modules/module5_optimization/README.md)
...
- [Entendiendo Modelos](./modules/module1_foundation/01_models_overview.md) - Elige el modelo correcto
- [Primera Llamada a la API](./modules/module1_foundation/07_first_api_call.md) - Tus primeros pasos
- [API de Mensajes](./modules/module2_core_api/01_messages_api.md) - Funcionalidad principal
- [Streaming](./modules/module2_core_api/04_streaming_basics.md) - Respuestas en tiempo real
- [Uso de Herramientas](./modules/module3_advanced_features/01_tool_use_basics.md) - Llamadas a funciones
- [Caché de Prompts](./modules/module3_advanced_features/05_prompt_caching.md) - Optimización de costes

### Práctica
- [Todos los Ejercicios](./exercises/README.md) - Práctica práctica
- [Proyectos de Muestra](./projects/README.md) - Ejemplos del mundo real
...
O sumérgete directamenente en el código con [Ejercicio 1: Hola Claude](./exercises/beginner/01_hello_claude.md)
